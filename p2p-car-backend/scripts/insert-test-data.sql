...
-- ============================================
--
-- This script inserts comprehensive test data for the P2P Car Rental platform
-- including users (hosts/owners), vehicles, and vehicle images.
--
-- Usage:
--   docker exec -i p2pcar-postgres psql -U p2pcar -d p2pcar < insert-test-data.sql
--
-- Or directly in the database:
--   psql -U p2pcar -d p2pcar -f insert-test-data.sql
--
-- ============================================
...
-- ============================================
-- Uncomment the following lines to clear existing data before inserting
...
-- ============================================
-- 2. INSERT TEST USERS (HOSTS/OWNERS)
-- ============================================
-- Password hash is 'password123' (bcrypt)
-- Creating 6 users: 5 owners and 1 renter
...
-- ============================================
-- 3. INSERT TEST VEHICLES (12 diverse vehicles)
-- ============================================
-- Includes: SUV, Sedan, MPV, Sports Car, Electric, Hybrid
-- Price range: ¥198 - ¥1888 per day
...
VALUES
    -- Vehicle 1: Tesla Model 3 (Electric Sedan) - ¥398/day
    (
    ...
    -- Vehicle 2: BMW X5 (Luxury SUV) - ¥688/day
    (
    ...
    -- Vehicle 3: Mercedes-Benz S-Class (Luxury Sedan) - ¥1288/day
    (
    ...
    -- Vehicle 4: Toyota Alphard (Luxury MPV) - ¥1088/day
    (
    ...
    -- Vehicle 5: Porsche 911 (Sports Car) - ¥1688/day
    (
    ...
    -- Vehicle 6: Honda Accord (Economy Sedan) - ¥288/day
    (
    ...
    -- Vehicle 7: Audi Q7 (Large SUV) - ¥888/day
    (
    ...
    -- Vehicle 8: BYD Han EV (Electric Sedan) - ¥368/day
    (
    ...
    -- Vehicle 9: Volkswagen Lavida (Compact Sedan) - ¥198/day
    (
    ...
    -- Vehicle 10: Lexus LM (Ultra Luxury MPV) - ¥1888/day
    (
    ...
    -- Vehicle 11: Ford Mustang (Muscle Car) - ¥688/day
    (
    ...
    -- Vehicle 12: Nissan Serena (Family MPV) - ¥328/day
    (
...
-- ============================================
-- 4. INSERT VEHICLE IMAGES (33 images total)
-- ============================================
-- Using high-quality Unsplash images
-- Each vehicle has 2-3 images with primary flag set

INSERT INTO vehicle_images (vehicle_id, url, is_primary, display_order, created_at)
VALUES
    -- Tesla Model 3 Images (3 images)
    ...
    -- Mercedes S-Class Images (3 images)
    ...
    -- Toyota Alphard Images (3 images)
    ...
    -- Volkswagen Lavida Images (2 images)
...
-- Display all vehicles with host information
SELECT '=====================================' as '';
SELECT 'Vehicle List with Host Information' as '';
SELECT '=====================================' as '';
...
SELECT
    ...
    v.rating || ' (' || v.review_count || ' reviews)' as reviews,
    u.name as host_name,
    CASE WHEN v.is_super_host THEN 'Yes' ELSE 'No' END as super_host,
    CASE WHEN v.instant_book THEN 'Yes' ELSE 'No' END as instant_book
FROM vehicles v
JOIN users u ON v.owner_id = u.id
ORDER BY v.id;

-- Display vehicle image counts
SELECT '=====================================' as '';
SELECT 'Vehicle Image Summary' as '';
SELECT '=====================================' as '';
...
SELECT '=====================================' as '';
SELECT 'Test data insertion completed!' as '';
SELECT '=====================================' as '';
